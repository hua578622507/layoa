...
import com.situ.layoa.base.PageData;
...
public class PageUtils implements Serializable {
	 ...
	 * @return
	 */
	public static PageData buildPageData(Integer count, Integer limit) {
		// countIndex = 61
		// 计算出可以分的总页数
		Integer pageCount = count % PAGE_ROWS == 0 ? count / PAGE_ROWS : count / PAGE_ROWS + 1;
		Integer beginIndex = (count - 1) * PAGE_ROWS + 1;// 开始的记录
		...
		return new PageData(beginIndex, endIndex, count, limit, pageCount, pageList);
	}
}
